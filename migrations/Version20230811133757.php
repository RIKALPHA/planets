...
final class Version20230811133757 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE planet (id INT NOT NULL, name VARCHAR(100) DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, status INT NOT NULL, robots_exploring INT NOT NULL, PRIMARY KEY(id))');
    }
